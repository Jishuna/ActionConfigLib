...
public class IsBossCondition extends Condition {

	private final EntityTarget target;
	private final boolean value;

	public IsBossCondition(ConfigurationEntry entry) throws ParsingException {
	...
	public boolean evaluate(ActionContext context) {
		...
		return (entity instanceof Boss) == this.value;
	}
